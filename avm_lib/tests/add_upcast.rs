...
fn operand_add_upcast_ok_8() {
	assert_eq!(Ok(Type::Double(75.00)), Type::Char(25) +Type::Double(50.00));
}
...
fn operand_add_upcast_ok_14() {
	assert_eq!(Ok(Type::Double(75.00)), Type::Short(25) + Type::Double(50.00));
}
...
fn operand_add_upcast_ok_20() {
	assert_eq!(Ok(Type::Double(75.00)), Type::Double(25.00) + Type::Float(50.00));
}
