...
fn operand_mul_upcast_ok_4() {
    assert_eq!(
        Ok(Type::Double(125.00)),
        Type::Double(5.00) * Type::Char(25)
    );
}
...
fn operand_mul_upcast_ok_11() {
    assert_eq!(
        Ok(Type::Double(125.00)),
        Type::Double(5.00) * Type::Short(25)
    );
}
...
fn operand_mul_upcast_ok_14() {
    assert_eq!(
        Ok(Type::Double(125.00)),
        Type::Short(25) * Type::Double(5.00)
    );
}
...
fn operand_mul_upcast_ok_19() {
    assert_eq!(
        Ok(Type::Double(125.00)),
        Type::Float(5.00) * Type::Double(25.00)
    );
}
...
fn operand_mul_upcast_ok_20() {
    assert_eq!(
        Ok(Type::Double(125.00)),
        Type::Double(25.00) * Type::Float(5.00)
    );
}
