...
fn stack_failed_assert_1() {
	...
	vec_tok.push(tok);
	//Test
	assert_eq!(ExecState::Error(instruction::ERR_FAILED_ASSERT),
		stack.run(&mut vec_tok));
}
...
fn stack_failed_assert_2() {
	...
	let tok = Token {val : Some(Type::Char(42)),
			...
			line : String::from("empty") , line_number : 0};
	vec_tok.push(tok);
	let tok = Token {val : Some(Type::Char(52)),
			inst : Some(instruction::assert),
			line : String::from("empty") , line_number : 0};
	vec_tok.push(tok);
	let tok = Token {val : None,
...
fn stack_add_assert() {
	...
	let tok = Token {val : None,
			...
			line : String::from("empty") , line_number : 0};
	vec_tok.push(tok);
	let tok = Token {val : Some(Type::Short(30)),
			inst : Some(instruction::assert),
			line : String::from("empty") , line_number : 0};
	vec_tok.push(tok);
	let tok = Token {val : None,
...
fn stack_sub_assert() {
	...
	let tok = Token {val : None,
			...
			line : String::from("empty") , line_number : 0};
	vec_tok.push(tok);
	let tok = Token {val : Some(Type::Short(-10)),
			inst : Some(instruction::assert),
			line : String::from("empty") , line_number : 0};
	vec_tok.push(tok);
	let tok = Token {val : None,
...
fn stack_mul_assert() {
	...
	let tok = Token {val : None,
			...
			line : String::from("empty") , line_number : 0};
	vec_tok.push(tok);
	let tok = Token {val : Some(Type::Short(200)),
			inst : Some(instruction::assert),
			line : String::from("empty") , line_number : 0};
	vec_tok.push(tok);
	let tok = Token {val : None,
...
fn stack_div_assert() {
	...
	let tok = Token {val : None,
			...
			line : String::from("empty") , line_number : 0};
	vec_tok.push(tok);
	let tok = Token {val : Some(Type::Short(0)),
			inst : Some(instruction::assert),
			line : String::from("empty") , line_number : 0};
	vec_tok.push(tok);
	let tok = Token {val : None,
