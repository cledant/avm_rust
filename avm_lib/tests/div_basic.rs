...
fn operand_div_float_ok() {
    assert_eq!(
        Ok(Type::Float(10000.5)),
        Type::Float(20001.0) / Type::Float(2.0)
    );
}
...
fn operand_div_0_float_failed() {
    assert_eq!(
        Err(value::ERR_DIV_0),
        Type::Float(std::f32::MAX) / Type::Float(0.0)
    );
}
...
fn operand_div_overflow_float_failed() {
    assert_eq!(
        Err(value::ERR_DIV_0),
        Type::Float(1.0e+20_f32) / Type::Float(1.0e-20_f32)
    );
}
...
fn operand_div_double_ok() {
    assert_eq!(
        Ok(Type::Double(10000.5)),
        Type::Double(20001.0) / Type::Double(2.0)
    );
}
...
fn operand_div_0_double_failed() {
    assert_eq!(
        Err(value::ERR_DIV_0),
        Type::Double(10000.0) / Type::Double(0.0)
    );
}
...
fn operand_div_overflow_double_failed() {
    assert_eq!(
        Err(value::ERR_DIV_0),
        Type::Double(1.0e+300_f64) / Type::Double(1.0e-300_f64)
    );
}
